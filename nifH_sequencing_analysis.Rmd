...
+ here I trimm the reference database using our primers. Note that the primer sequences will be trimmed, too. 
...
/Applications/bbmap/bbduk2.sh in=nifH_analysis/nifH_dna.fasta \
      fliteral=GCIWTHTAYGGIAARGGIGGIATHGGIAA,ATIGCRAAICCICCRCAIACIACRTC \
			minkmerhits=2 \
			k=17 \
			copyundefined \
			rcomp=t \
...
/Applications/vsearch/bin/vsearch --usearch_global nifH_analysis/complete_set.fasta \
    ...
    --log cluster.log \
    --maxrejects 64 \
    --uc 16S_analysis/otu_table_nifh.uc
```